import { BadGatewayException, ConflictException, Injectable, InternalServerErrorException } from "@nestjs/common";
...
export class ChatService {
  ...
  async getChatSessionById(sessionId: number) {
    const result = await this.postgresService.client.query<{id: number, user_id: number, created_at: Date}>(
      `
